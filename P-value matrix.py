...
# Convert all columns to float, assuming all should be numeric
data = data.apply(pd.to_numeric, errors='coerce')

# Function to calculate the Proportional Index between two columns
